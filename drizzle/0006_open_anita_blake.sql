...
ALTER TABLE "user_tokens" ADD COLUMN "coin_gecko_id" text;--> statement-breakpoint
ALTER TABLE "user_tokens" ADD COLUMN "image_url" text;--> statement-breakpoint
ALTER TABLE "user_tokens" ADD COLUMN "market_cap_rank" integer;--> statement-breakpoint
